x<-seq(0,5,0.001)
generate_ecg <- function(x,bpm,a1,a2,a3,a4,a5){          
  #a1= amplitude of p, a2= amplitude of q, a3= amplitude of QR, 
  #a4= amplitude of S, a5= amplitude of T wave
  l= 60 / bpm 
  p_wav<-function(x){
    x=x+(1/1.4)# x is the wave starting point shifted .
    b=3.9# l/b is duration of p wave.
...
generate_ecg(x,60,0.15,.025,1,.25,0.25)
